...
import {
    PiggyBank, ArrowRight, TrendingUp, Shield, Zap,
    BarChart3, CreditCard, Users, Lock, LineChart, FileText,
} from 'lucide-react';
                ...
                <div className="mx-auto max-w-7xl">
                    <div className={cn(
                        ...
                        <div className="hidden md:flex items-center gap-7 text-sm font-medium">
                            {[['#features', 'Features'], ['#metrics', 'Why Us'], ['#pricing', 'Pricing']].map(([href, label]) => (
                                <a
                                    key={href}
                                    href={href}
